                  ...
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <NavLink 
                        ...
                        className={({ isActive }) =>
                          isActive
                            ? "bg-primary/15 text-primary font-semibold rounded-r-lg border-l-4 border-primary [&>svg]:text-primary [&>svg]:animate-icon-pulse pl-3 shadow-[inset_0_0_20px_rgba(59,130,146,0.1)] transition-all duration-300"
